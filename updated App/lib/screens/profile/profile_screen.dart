  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        boxShadow: [
          BoxShadow(color: c.accentGlow, blurRadius: 12, offset: const Offset(0, 4)),
        ],
      ),
      child: Row(
        children: [
...
class _MenuCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: Column(
        children: [
          _MenuRow(icon: LucideIcons.user, label: 'Edit Profile', onTap: onEditProfile),
          Divider(height: 1, color: c.cardBorder, indent: 56),
          _MenuRow(icon: LucideIcons.graduationCap, label: 'Exam Goal', onTap: onExamGoal),
          Divider(height: 1, color: c.cardBorder, indent: 56),
          _MenuRow(icon: LucideIcons.settings, label: 'Settings', onTap: onSettings),
          Divider(height: 1, color: c.cardBorder, indent: 56),
          _MenuRow(icon: LucideIcons.helpCircle, label: 'Help & Support', onTap: onHelp),
          Divider(height: 1, color: c.cardBorder, indent: 56),
          _MenuRow(
