    ...
    <div class="flex h-screen">
        ...
        <main class="flex-1 overflow-y-auto">
            <header class="bg-[#0a0a0a] border-b border-gray-800/50 px-6 py-4">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <h1 class="text-base font-semibold text-white">Edit Page</h1>
                        <p class="text-xs text-gray-500 mt-0.5">Update page content and settings</p>
                    </div>
                    <a href="{{ route('page.show', $page->slug) }}" target="_blank"
                       class="px-4 py-2 bg-white/5 hover:bg-white/10 text-gray-300 text-sm font-medium rounded-lg transition-colors flex items-center gap-2">
            ...
            <div class="p-6">
                ...
                <form action="{{ route('admin.pages.update', $page->id) }}" method="POST" class="card rounded-lg p-6">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                        ...
                        <div>
                            <label class="block text-xs font-medium text-gray-400 mb-1.5">URL Slug</label>
                    ...
                    <div class="mb-4">
                        ...
                        <textarea name="content" rows="12" required
                                  ...
                                  placeholder="Write your page content here. HTML formatting is supported.">{{ old('content', $page->content) }}</textarea>
                    ...
                    <div class="mb-4 p-3 bg-white/5 rounded-lg">
                        ...
                        <div class="grid grid-cols-2 md:grid-cols-4 gap-3">
                            ...
                            <label class="flex items-center gap-2 cursor-pointer">
                                <input type="checkbox" name="show_in_app" value="1" {{ $page->show_in_app ? 'checked' : '' }}
                                       class="w-4 h-4 rounded border-gray-600 bg-white/10 text-blue-500 focus:ring-blue-500">
