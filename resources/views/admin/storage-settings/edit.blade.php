                                ...
                                <div>
                                    ...
                                    <div class="space-y-4">
                                        <div>
                                            ...
                                            <input type="text" name="bucket" value="{{ old('bucket', $storageSetting->bucket) }}" required placeholder="e.g., blinkstudy-uploads"
                                                   class="w-full px-3 py-2 bg-gray-800 border border-gray-700 rounded-lg text-sm text-white placeholder-gray-500 focus:outline-none focus:border-blue-500">
                                        ...
                                        <div>
                                            ...
                                            <input type="url" name="cdn_url" value="{{ old('cdn_url', $storageSetting->cdn_url) }}" placeholder="{{ env('FILES_SUBDOMAIN_URL', config('app.url')) }}"
                                                   class="w-full px-3 py-2 bg-gray-800 border border-gray-700 rounded-lg text-sm text-white placeholder-gray-500 focus:outline-none focus:border-blue-500">
