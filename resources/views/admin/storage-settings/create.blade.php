        ...
        <main class="flex-1 overflow-y-auto">
            ...
            <header class="bg-[#0a0a0a] border-b border-gray-800/50 px-6 py-4">
                <div class="flex items-center gap-4">
                    ...
                    <div>
                        <h1 class="text-base font-semibold text-white">Add New Storage</h1>
                        <p class="text-xs text-gray-500 mt-0.5">Configure Cloudflare R2 / S3 Storage</p>
                    </div>
                </div>
            </header>
            ...
            <div class="p-6">
                <div class="max-w-4xl mx-auto">
                    <div class="card rounded-lg p-6">
                        <form method="POST" action="{{ route('admin.storage-settings.store') }}">
                            @csrf
                                ...
                                <div>
                                    ...
                                    <div class="space-y-4">
                                        <div>
                                            ...
                                            <input type="text" name="name" value="{{ old('name') }}" required placeholder="e.g., Cloudflare R2 Production"
                                        ...
                                        <div>
                                            ...
                                            <select name="driver" required
                                                ...
                                                <option value="r2" {{ old('driver') === 'r2' ? 'selected' : '' }}>Cloudflare R2</option>
                                                <option value="s3" {{ old('driver') === 's3' ? 'selected' : '' }}>AWS S3</option>
                                                <option value="local" {{ old('driver') === 'local' ? 'selected' : '' }}>Local Storage</option>
                                            </select>
                                        ...
                                        <div>
                                            ...
                                            <input type="text" name="key" value="{{ old('key') }}" placeholder="Your R2 Account ID or Access Key"
                                                   class="w-full px-3 py-2 bg-gray-800 border border-gray-700 rounded-lg text-sm text-white placeholder-gray-500 focus:outline-none focus:border-blue-500">
                                        ...
                                        <div>
                                            ...
                                            <input type="password" name="secret" value="{{ old('secret') }}" placeholder="Your R2 API Token or Secret Key"
                                                   class="w-full px-3 py-2 bg-gray-800 border border-gray-700 rounded-lg text-sm text-white placeholder-gray-500 focus:outline-none focus:border-blue-500">
                                            <p class="text-xs text-gray-500 mt-1">Keep this secure! Never share with others.</p>
                                        ...
                                        <div>
                                            ...
                                            <input type="text" name="region" value="{{ old('region', 'auto') }}" placeholder="auto"
                                                   class="w-full px-3 py-2 bg-gray-800 border border-gray-700 rounded-lg text-sm text-white placeholder-gray-500 focus:outline-none focus:border-blue-500">
                                ...
                                <div>
                                    ...
                                    <div class="space-y-4">
                                        ...
                                        <div>
                                            ...
                                            <input type="url" name="endpoint" value="{{ old('endpoint') }}" required placeholder="https://YOUR_ACCOUNT_ID.r2.cloudflarestorage.com"
                                                   class="w-full px-3 py-2 bg-gray-800 border border-gray-700 rounded-lg text-sm text-white placeholder-gray-500 focus:outline-none focus:border-blue-500">
                                        ...
                                        <div>
                                            ...
                                            <input type="text" name="url_prefix" value="{{ old('url_prefix') }}" placeholder="uploads"
                                                   class="w-full px-3 py-2 bg-gray-800 border border-gray-700 rounded-lg text-sm text-white placeholder-gray-500 focus:outline-none focus:border-blue-500">
                            ...
                            <div class="mt-6 pt-6 border-t border-gray-800">
                                ...
                                <div class="grid grid-cols-2 gap-6">
                                    <div>
                                        ...
                                        <input type="number" name="max_file_size" value="{{ old('max_file_size', 10) }}" min="1" max="100"
                                               class="w-full px-3 py-2 bg-gray-800 border border-gray-700 rounded-lg text-sm text-white focus:outline-none focus:border-blue-500">
                                        ...
                                        <div class="p-3 bg-gray-800 border border-gray-700 rounded-lg max-h-32 overflow-y-auto">
                                            ...
                                            <label class="flex items-center gap-2 py-1 cursor-pointer">
                                                <input type="checkbox" name="allowed_extensions[]" value="{{ $ext }}"
                                                    {{ in_array($ext, old('allowed_extensions', ['jpg', 'jpeg', 'png', 'gif', 'webp', 'pdf'])) ? 'checked' : '' }}
                            ...
                            <div class="mt-6">
                                ...
                                <textarea name="notes" rows="2" placeholder="Add any notes about this storage configuration..."
                                          class="w-full px-3 py-2 bg-gray-800 border border-gray-700 rounded-lg text-sm text-white placeholder-gray-500 focus:outline-none focus:border-blue-500 resize-none">{{ old('notes') }}</textarea>
