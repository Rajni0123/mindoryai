...
<head>
    ...
    <title>Add Feature | Admin Dashboard</title>
        ...
        <main class="flex-1 overflow-y-auto">
            ...
            <header class="bg-gray-900/30 backdrop-blur-sm border-b border-gray-800 p-6">
                <div class="flex items-center justify-between">
                    <div>
                        <h2 class="text-2xl font-bold font-display text-white">Add New Feature</h2>
                        <p class="text-soft-grey/70 text-sm mt-1">Create a new feature highlight</p>
                    </div>
            ...
            <div class="p-6">
                <div class="max-w-3xl mx-auto">
                    <form method="POST" action="{{ route('admin.features.store') }}" class="bg-gray-900/50 backdrop-blur-sm border border-gray-800 rounded-xl p-6 space-y-6">
                        @csrf
                        ...
                        <div>
                            ...
                            <div class="flex gap-2">
                                ...
                                <div id="iconPreview" class="flex items-center justify-center w-14 h-14 rounded-lg bg-neon-blue/20 border border-neon-blue/30">
                                    <span class="material-symbols-outlined text-neon-blue">help</span>
                                </div>
                            </div>
                        ...
                        <div>
                            ...
                            <select id="color"
                                ...
                                <option value="blue" {{ old('color') === 'blue' ? 'selected' : '' }}>Blue (Neon Blue)</option>
                                <option value="violet" {{ old('color') === 'violet' ? 'selected' : '' }}>Violet (Neon Violet)</option>
                            </select>
                            @error('color')
                            <p class="mt-2 text-sm text-red-400">{{ $message }}</p>
                            @enderror
