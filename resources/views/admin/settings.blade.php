...
<!-- IP Whitelist Section -->
                    ...
                    <div class="glass-effect rounded-xl p-6">
                        ...
                        <div class="space-y-4">
                            ...
                            <div class="flex items-center justify-between p-4 bg-gray-800/30 border border-gray-700 rounded-lg">
                                <div class="flex items-center gap-3">
                                    <span class="material-icons-outlined text-green-400">chat</span>
                                    <div>
                                        <p class="text-sm font-semibold text-white">Chat Page (/chat)</p>
                                        <p class="text-xs text-soft-grey/70">Enable or disable the AI chat page for all users</p>
                                    </div>
                                </div>
                                <label class="relative inline-flex items-center cursor-pointer">
                                    <input type="checkbox"
                                           id="chat_enabled"
                                           name="chat_enabled"
                                           {{ old('chat_enabled', $settings['chat_enabled'] ?? '1') == '1' ? 'checked' : '' }}
                                           class="sr-only peer">
                                    <div class="w-11 h-6 bg-gray-700 peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-green-500/20 rounded-full peer peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all peer-checked:bg-green-500"></div>
                                </label>
                            </div>
