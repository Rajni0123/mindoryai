                    ...
                    <tr>
                        <td class="content-padding" style="padding: 32px 40px;">
                            ...
                            <p style="font-size:14px; color:#475569; margin-bottom:24px; line-height:1.7;">
                                @if($daysLeft === 0)
                                    Your <strong>{{ $planName }}</strong> plan expires <strong style="color:#dc2626;">today ({{ $expiryDate }})</strong>. After expiry, premium features will be disabled until you renew.
                                @elseif($daysLeft === 1)
