...
<body class="min-h-screen flex items-center justify-center p-4 bg-gray-50 dark:bg-slate-900 text-slate-800 dark:text-white">
    <div class="w-full max-w-sm">
        ...
        <div class="bg-white dark:bg-slate-800 rounded-2xl p-6 shadow-xl shadow-black/5 dark:shadow-black/20 fade-in">
            ...
            <div class="mb-5">
                <a href="{{ route('google.redirect') }}" class="w-full py-3 px-4 rounded-xl bg-white hover:bg-gray-50 text-slate-800 text-sm font-semibold flex items-center justify-center gap-3 transition-all shadow-sm border border-slate-200">
                ...
                <div class="relative my-5">
                    ...
                    <div class="relative flex justify-center text-xs">
                        <span class="px-3 bg-white dark:bg-slate-800 text-slate-400">OR</span>
                    </div>
                </div>
            </div>
            @endif
