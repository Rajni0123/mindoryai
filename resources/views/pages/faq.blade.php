...
@section('title', 'FAQ - ' . config('app.name', 'Mindory'))
@section('description', 'Find quick answers to common questions about Mindory. Account, billing, features, refunds, and more.')
...
<div class="max-w-4xl mx-auto px-4 py-12">
    ...
    <div class="text-center mb-10">
        ...
        <p class="dark:text-gray-400 text-gray-600 max-w-xl mx-auto text-sm">
            Find quick answers to common questions about Mindory. Can't find what you're looking for? Contact us at
            <a href="mailto:support@mindory.in" class="text-primary hover:underline">support@mindory.in</a>
        </p>
    ...
    $sections = [
        [
            ...
            'color' => 'primary',
            'faqs' => [
                ['q' => 'How do I create an account on Mindory?', 'a' => 'Simply download the Mindory app or visit www.mindory.in, enter your mobile number, verify the OTP sent to your phone, and you\'re ready to start learning!'],
                ['q' => 'I\'m not receiving the OTP. What should I do?', 'a' => "Check if you entered the correct mobile number. Wait for 2-3 minutes (sometimes there's a delay). Check your phone's message/SMS app. Ensure you have network connectivity. Try requesting OTP again after 5 minutes. Contact support at support@mindory.in if issue persists."],
                ...
                ['q' => 'Can I use one account on multiple devices?', 'a' => 'Yes! You can log in to your Mindory account on multiple devices (phone, tablet, computer) simultaneously. Your progress syncs across all devices.'],
                ['q' => 'How do I reset/change my password?', 'a' => 'Mindory uses OTP-based login, so there\'s no password to remember! Simply enter your mobile number and verify OTP each time you log in.'],
                ['q' => 'Can I change my registered mobile number?', 'a' => 'Yes, contact our support team at support@mindory.in with your current mobile number and new mobile number. We\'ll assist you with the change.'],
                ['q' => 'How do I delete my account?', 'a' => 'Go to Settings → Account → Delete Account, or email us at support@mindory.in. Please note that account deletion is permanent and cannot be undone.'],
            ],
        ],
        [
            'icon' => 'credit_card',
            ...
            'color' => 'secondary',
            'faqs' => [
                ['q' => 'What subscription plans does Mindory offer?', 'a' => 'We offer three plans: FREE Plan (₹0 - Limited features, ad-supported), BASIC Plan (₹149/month - Enhanced features, no ads), and PRO Plan (₹999/month - Unlimited features, priority support).'],
                ['q' => 'Is there a free trial?', 'a' => 'Yes! All new users start with a FREE plan to explore Mindory. You can upgrade anytime to unlock premium features.'],
                ...
                ['q' => 'How do I cancel my subscription?', 'a' => 'Go to Settings → Subscription → Cancel Plan. You can also email support@mindory.in. You\'ll continue to have access until the end of your billing period.'],
            ],
        ],
        [
            'icon' => 'payments',
            ...
            'faqs' => [
                ...
                ['q' => 'My payment failed but money was deducted. What should I do?', 'a' => 'Don\'t worry! If payment fails, the amount is usually refunded within 5-7 business days automatically. If not, contact support@mindory.in with your transaction ID.'],
                ['q' => 'Can I get a refund?', 'a' => 'Yes! We offer a 7-day money-back guarantee for first-time subscribers. Simply email support@mindory.in within 7 days of purchase.'],
        ...
        [
            ...
            'faqs' => [
                ...
                ['q' => 'Does Mindory work offline?', 'a' => 'Currently, Mindory requires internet connection for AI-powered features. Offline mode is coming soon!'],
                ['q' => 'What subjects does Mindory cover?', 'a' => 'We cover all major subjects for JEE and NEET: Mathematics, Physics, Chemistry, Biology (Botany & Zoology).'],
                ['q' => 'Can I use Mindory for board exams (not just JEE/NEET)?', 'a' => 'Absolutely! While optimized for JEE/NEET, Mindory works great for Class 11-12 board exam preparation too.'],
            ],
        ],
        [
            'icon' => 'smart_toy',
            ...
            'faqs' => [
                ...
                ['q' => 'Can the AI tutor explain concepts in Hindi?', 'a' => 'Currently, Mindory primarily works in English. Hindi language support is on our roadmap!'],
        ...
        [
            ...
            'color' => 'error',
            'faqs' => [
                ['q' => 'The app is not loading. What should I do?', 'a' => 'Check your internet connection. Close and reopen the app. Clear app cache (Settings → Apps → Mindory → Clear Cache). Update to the latest version. Restart your device. Contact support if issue persists.'],
                ...
                ['q' => 'Which devices are compatible with Mindory?', 'a' => 'Android: 5.0 and above, iOS: 12.0 and above, Web: All modern browsers (Chrome, Firefox, Safari, Edge).'],
        ...
        [
            ...
            'color' => 'success',
            'faqs' => [
                ['q' => 'Is my personal data safe with Mindory?', 'a' => 'Yes! We use bank-grade encryption and follow strict data protection policies. Read our Privacy Policy for details.'],
        ...
        [
            ...
            'color' => 'info',
            'faqs' => [
                ['q' => 'How do I contact customer support?', 'a' => 'Email us at support@mindory.in. We respond within 24 hours (Monday-Saturday, 9 AM - 8 PM IST).'],
                ...
                ['q' => 'How do I report a bug or technical issue?', 'a' => 'Email support@mindory.in with: Device details (Android/iOS, version), App version, Screenshot/screen recording, and a detailed description of the issue.'],
            ],
        ],
        [
            'icon' => 'card_giftcard',
            ...
            'color' => 'secondary',
            'faqs' => [
                ['q' => 'Is there a referral program?', 'a' => 'Referral program is coming soon! You\'ll be able to earn rewards by inviting friends to Mindory.'],
        ...
        [
            ...
            'faqs' => [
                ...
                ['q' => 'Can I request specific topics to be added?', 'a' => 'Yes! Share your suggestions at support@mindory.in. We prioritize user-requested content.'],
            ],
        ],
        [
            'icon' => 'gavel',
            ...
            'color' => 'error',
            'faqs' => [
                ['q' => 'Where can I read your Terms & Conditions?', 'a' => 'Visit www.mindory.in/terms or check the app footer for complete Terms & Conditions.'],
                ['q' => 'What is your Privacy Policy?', 'a' => 'Full Privacy Policy is available at www.mindory.in/privacy'],
                ['q' => 'What is your Refund Policy?', 'a' => 'Detailed Refund & Cancellation Policy: www.mindory.in/refund'],
            ],
        ],
        [
            'icon' => 'star',
            ...
            'color' => 'secondary',
            'faqs' => [
                ['q' => 'Can schools/coaching institutes use Mindory?', 'a' => 'Yes! We offer bulk licensing for educational institutions. Contact support@mindory.in for details.'],
                ['q' => 'Is Mindory available in languages other than English?', 'a' => 'Currently English only. Hindi and other regional languages are planned for future releases.'],
                ['q' => 'Can I suggest new features?', 'a' => 'Absolutely! We love user feedback. Email your ideas to support@mindory.in'],
                ['q' => 'How is Mindory different from other learning apps?', 'a' => 'Mindory combines advanced AI technology, personalized learning paths, scan-to-solve convenience, affordable pricing, exam-focused content, and 24/7 availability.'],
                ['q' => 'Who founded Mindory?', 'a' => 'Mindory was founded by Rajnish Kumar, an educator and technology enthusiast from Patna, Bihar.'],
            ],
        ],
        [
            'icon' => 'rocket_launch',
    ...
    <div class="mt-12 dark:bg-white/[0.02] bg-white rounded-2xl border dark:border-white/[0.06] border-gray-200 p-6 md:p-8 text-center shadow-sm">
        ...
        <div class="flex flex-col sm:flex-row items-center justify-center gap-3 text-sm">
            <a href="mailto:support@mindory.in" class="inline-flex items-center gap-2 px-5 py-2.5 bg-primary text-white rounded-xl font-medium hover:bg-primary/90 transition-colors">
