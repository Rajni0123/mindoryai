            ...
            <div class="sidebar-user p-3 border-t border-[var(--border-color)] relative">
                <div onclick="toggleUserMenu()" class="sidebar-nav-item flex items-center gap-3 px-3 py-2 rounded-lg hover:bg-[var(--bg-hover)] cursor-pointer transition-colors group">
                    <div class="avatar avatar-user" style="width: 32px; height: 32px; font-size: 14px;">
                        <?php echo e(auth()->user()->name ? substr(auth()->user()->name, 0, 1) : 'U'); ?>

                    </div>
                    <div class="user-info flex-1 min-w-0">
                        <div class="text-sm font-medium truncate"><?php echo e(auth()->user()->name ?? 'User'); ?></div>
                        <div class="text-xs text-[var(--text-secondary)] flex items-center gap-1">
                            ...
                            ?>
                            <span><?php echo e($planName); ?> plan</span>
                        </div>
                    </div>
                </div>
                ...
                <div id="userPopupMenu" class="user-popup-menu hidden">
                    <div class="popup-header">
                        <span class="text-sm text-[var(--text-secondary)]"><?php echo e(auth()->user()->email ?? 'user@email.com'); ?></span>
                    </div>
                    ...
                    <div class="popup-item-with-submenu" onmouseenter="showSubmenu('languageSubmenu')" onmouseleave="hideSubmenuDelayed('languageSubmenu')">
                        ...
                        <div id="languageSubmenu" class="popup-submenu hidden" onmouseenter="keepSubmenuOpen('languageSubmenu')" onmouseleave="hideSubmenu('languageSubmenu')">
                            <div class="popup-item <?php echo e($currentLang == 'en' ? 'active' : ''); ?>" onclick="setLanguage('en');">
                                <span style="margin-right: 8px;">🇺🇸</span><span>English</span>
                            </div>
                            <div class="popup-item <?php echo e($currentLang == 'hi' ? 'active' : ''); ?>" onclick="setLanguage('hi');">
                                <span style="margin-right: 8px;">🇮🇳</span><span>हिंदी (Hindi)</span>
                            </div>
                            <div class="popup-item <?php echo e($currentLang == 'es' ? 'active' : ''); ?>" onclick="setLanguage('es');">
                                <span style="margin-right: 8px;">🇪🇸</span><span>Español</span>
                            </div>
                            <div class="popup-item <?php echo e($currentLang == 'fr' ? 'active' : ''); ?>" onclick="setLanguage('fr');">
                                <span style="margin-right: 8px;">🇫🇷</span><span>Français</span>
                            </div>
                            <div class="popup-item <?php echo e($currentLang == 'de' ? 'active' : ''); ?>" onclick="setLanguage('de');">
                                <span style="margin-right: 8px;">🇩🇪</span><span>Deutsch</span>
                            </div>
                            <div class="popup-item <?php echo e($currentLang == 'zh' ? 'active' : ''); ?>" onclick="setLanguage('zh');">
                                <span style="margin-right: 8px;">🇨🇳</span><span>中文</span>
                            </div>
                            <div class="popup-item <?php echo e($currentLang == 'ja' ? 'active' : ''); ?>" onclick="setLanguage('ja');">
                                <span style="margin-right: 8px;">🇯🇵</span><span>日本語</span>
                            </div>
                            <div class="popup-item <?php echo e($currentLang == 'ar' ? 'active' : ''); ?>" onclick="setLanguage('ar');">
                    ...
                    ?>
                    <?php if($downloadUrl && $downloadUrl !== '#'): ?>
                    <a href="<?php echo e($downloadUrl); ?>" target="_blank" class="popup-item" onclick="closeUserMenu();">
                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div class="absolute right-0 top-0 bottom-0 w-full max-w-md bg-[var(--bg-primary)] shadow-2xl overflow-y-auto">
                ...
                <div class="p-6 space-y-6">
                    ...
                    <div>
                        ...
                        <div class="space-y-3">
                            <div class="flex items-center gap-4 p-4 bg-[var(--bg-secondary)] rounded-lg">
                                ...
                                <div class="flex-1">
                                    <div class="font-medium"><?php echo e(auth()->user()->name ?? 'User'); ?></div>
                                    <div class="text-sm text-[var(--text-secondary)]"><?php echo e(auth()->user()->email ?? ''); ?></div>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <div class="space-y-3">
                            ...
                            <div class="flex items-center justify-between p-4 bg-[var(--bg-secondary)] rounded-lg">
                                <div>
                                    <div class="font-medium"><?php echo e($planName); ?> Plan</div>
                                    <div class="text-sm text-[var(--text-secondary)]"><?php echo e($planCredits); ?> credits/month</div>
                                </div>
                                <?php if($isFree): ?>
                                <a href="<?php echo e(route('plans')); ?>" class="px-4 py-2 bg-[var(--accent-color)] hover:opacity-90 text-white text-sm font-medium rounded-lg transition-colors">
                                    Upgrade
                                </a>
                                <?php else: ?>
                        ...
                        <div class="space-y-3">
                            ...
                            <div class="p-4 bg-[var(--bg-secondary)] rounded-lg">
                                <div class="flex items-center justify-between mb-3">
                                    ...
                                    <span class="text-lg font-semibold"><?php echo e(number_format($availableCredits)); ?></span>
                                </div>
                                <div class="w-full bg-[var(--bg-hover)] rounded-full h-2 overflow-hidden">
                                    <div class="bg-[var(--accent-color)] h-full transition-all" style="width: <?php echo e($totalEarned > 0 ? min(100, ($availableCredits / $totalEarned) * 100) : 0); ?>%"></div>
                                </div>
                                <div class="flex justify-between text-xs text-[var(--text-secondary)] mt-2">
                                    <span>Earned: <?php echo e(number_format($totalEarned)); ?></span>
                                    <span>Spent: <?php echo e(number_format($totalSpent)); ?></span>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <div class="space-y-3">
                            <div class="flex items-center justify-between p-4 bg-[var(--bg-secondary)] rounded-lg">
                                ...
                                <button id="themeToggleBtn" onclick="toggleTheme(); updateThemeToggle()" class="toggle-switch <?php echo e((isset($_COOKIE['theme']) && $_COOKIE['theme'] === 'dark') ? 'active' : ''); ?>"></button>
                            </div>
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <div class="space-y-2">
                            <a href="<?php echo e(route('user.settings')); ?>" class="flex items-center justify-between p-4 bg-[var(--bg-secondary)] rounded-lg hover:bg-[var(--bg-hover)] transition-colors">
                            ...
                            <a href="<?php echo e(route('logout')); ?>" class="flex items-center justify-between p-4 bg-[var(--bg-secondary)] rounded-lg hover:bg-red-500/10 transition-colors group">
                                <div class="flex items-center gap-3">
        ...
        <main class="flex-1 flex flex-col bg-[var(--bg-primary)]">
            ...
            <div class="flex-shrink-0 px-4 pb-4 pt-2">
                <div class="max-w-3xl mx-auto">
                    ...
                    <input type="hidden" id="selectedAiModel" name="model_id" value="<?php echo e($selectedAiModel->id ?? ''); ?>">
...
<?php if(auth()->check() && !auth()->user()->profile_completed): ?>
<style>
        ...
        <div class="pp-body">
            ...
            <form id="pp-form">
                <div class="pp-field">
                    ...
                    <input type="text" id="pp-name" value="<?php echo e(auth()->user()->name); ?>" placeholder="Enter your name" required minlength="2" maxlength="50">
                </div>
                <div class="pp-field">
                ...
                <div class="pp-field">
                    ...
                    <div class="pp-phone">
                        <span>+91</span>
                        <span class="pp-num"><?php echo e(auth()->user()->mobile); ?></span>
...
<?php /**PATH I:\heris the code\resources\views/pages/chat.blade.php ENDPATH**/ ?>