...
class ExpireSubscriptions extends Command
{
    ...
    protected $description = 'Remove subscriptions for users whose paid plan has expired (after grace period)';
    ...
    public function handle(): int
    {
        ...
        $this->info("Removed subscription for {$count} expired users.");
        Log::info("Subscription expiry: {$count} users had subscriptions removed.", [
            'grace_days' => $graceDays,
