...
class User extends Authenticatable
{
    ...
    /**
     * Google/social users who still need to add a phone number.
     */
    public function needsPhoneCollection(): bool
    {
        if (StudyProfileCatalog::isAutoGeneratedEmail($this->email)) {
            return false;
        }
        ...
        return empty($this->mobile) || empty($this->mobile_verified_at);
    }

    public function profileEmail(): ?string
    {
        return StudyProfileCatalog::displayEmail($this->email);
    }
