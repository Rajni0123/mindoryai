    ...
    public function run(): void
    {
        $configs = [
            ...
            [
                ...
                'type' => 'string',
                'value' => 'ca-app-pub-4879680310084425~3564643089',
                'label' => 'AdMob App ID (Android)',
                'category' => 'ads',
                'description' => 'Google AdMob Android App ID',
                'is_public' => false,
            ],
            [
                ...
                'category' => 'ads',
                'description' => 'Google AdMob iOS App ID',
                'is_public' => false,
            ],
            [
                'key' => 'ads.banner_id_android',
                'type' => 'string',
                'value' => 'ca-app-pub-4879680310084425/6331241376',
                'label' => 'Banner Ad ID (Android)',
                'category' => 'ads',
                'description' => 'AdMob banner unit ID for Android',
                'is_public' => true,
            ],
            [
                ...
                'category' => 'ads',
                'description' => 'AdMob banner unit ID for iOS',
                'is_public' => true,
            ],
            [
                'key' => 'ads.interstitial_id_android',
                'type' => 'string',
                'value' => 'ca-app-pub-4879680310084425/9316497362',
                'label' => 'Interstitial Ad ID (Android)',
                'category' => 'ads',
                'description' => 'AdMob interstitial unit ID for Android',
                'is_public' => true,
            ],
            [
                ...
                'category' => 'ads',
                'description' => 'AdMob interstitial unit ID for iOS',
                'is_public' => true,
            ],
            [
                'key' => 'ads.native_id_android',
                'type' => 'string',
                'value' => 'ca-app-pub-4879680310084425/6721279722',
                'label' => 'Native Ad ID (Android)',
                'category' => 'ads',
                'description' => 'AdMob native unit ID for Android',
                'is_public' => true,
            ],
            [
                'key' => 'ads.native_id_ios',
                'type' => 'string',
                'value' => 'ca-app-pub-4879680310084425/6721279722',
                'label' => 'Native Ad ID (iOS)',
                'category' => 'ads',
                'description' => 'AdMob native unit ID for iOS',
                'is_public' => true,
            ],
            [
                'key' => 'ads.rewarded_id_android',
                'type' => 'string',
                'value' => 'ca-app-pub-4879680310084425/5354046379',
                'label' => 'Rewarded Ad ID (Android)',
                'category' => 'ads',
                'description' => 'AdMob rewarded unit ID for Android',
                'is_public' => true,
            ],
            [
                ...
                'category' => 'ads',
                'description' => 'AdMob rewarded unit ID for iOS',
                'is_public' => true,
            ],
            [
