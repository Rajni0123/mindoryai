    ...
    public function run(): void
    {
        $exams = [
            ...
            [
                'name' => 'CBSE Class 10',
                'slug' => 'cbse-class-10',
                'description' => 'CBSE Board Examination for Class 10 - Previous Year Question Papers (2020-2024)',
                'category' => 'board',
                'level' => 'board',
                ...
                'config' => [
                    ...
                    'pyq_available' => true,
                    'pyq_years' => [2018, 2019, 2020, 2021, 2022, 2023, 2024],
                    'paper_type' => 'board',
                    'total_marks' => 80,
                    'sections' => [
                        'A' => ['marks' => 1, 'questions' => 20, 'type' => 'MCQ / Very Short Answer'],
                        'B' => ['marks' => 2, 'questions' => 5, 'type' => 'Short Answer I'],
                        'C' => ['marks' => 3, 'questions' => 6, 'type' => 'Short Answer II'],
                        'D' => ['marks' => 5, 'questions' => 4, 'type' => 'Long Answer'],
                    ],
                ],
                'is_active' => true,
                'order' => 6,
            ...
            [
                'name' => 'CBSE Class 12',
                'slug' => 'cbse-class-12',
                'description' => 'CBSE Board Examination for Class 12 - Previous Year Question Papers (2020-2024)',
                'category' => 'board',
                'level' => 'board',
                ...
                'config' => [
                    ...
                    'total_marks' => 70,
                    'sections' => [
                        'A' => ['marks' => 1, 'questions' => 16, 'type' => 'MCQ / Assertion-Reason'],
                        'B' => ['marks' => 2, 'questions' => 5, 'type' => 'Short Answer I'],
                        'C' => ['marks' => 3, 'questions' => 7, 'type' => 'Short Answer II'],
                        'D' => ['marks' => 5, 'questions' => 3, 'type' => 'Long Answer / Case Study'],
                    ],
                ],
                'is_active' => true,
                'order' => 7,
